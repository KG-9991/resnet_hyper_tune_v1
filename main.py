...
def configure():
    ...
    parser.add_argument("--modeldir", type=str, default='model_#3_hyp_ver1_no8', help='model directory')
    parser.add_argument("--learning_rate", type=float, default=0.1, help='learning rate')
    parser.add_argument("--model_number", type=int, default=8, help='model number')
    ### YOUR CODE HERE
